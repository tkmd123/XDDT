...
export class DiemDotBienUpdate extends React.Component<IDiemDotBienUpdateProps, IDiemDotBienUpdateState> {
  ...
  render() {
    const { diemDotBienEntity, vungADNS, mauXetNghiems, loading, updating } = this.props;
          ...
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : diemDotBienEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label for="mauDiemDotBien.id">
                    <Translate contentKey="xddtApp.diemDotBien.mauDiemDotBien">Mau Diem Dot Bien</Translate>
                  </Label>
                  <AvInput id="diem-dot-bien-mauDiemDotBien" type="select" className="form-control" name="mauDiemDotBien.id">
                    <option value="" key="0" />
                    {mauXetNghiems
