          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('giaTri1')}>
                  <Translate contentKey="xddtApp.diemDotBien.giaTri1">Gia Tri 1</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('giaTri2')}>
                  <Translate contentKey="xddtApp.diemDotBien.giaTri2">Gia Tri 2</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                  <Translate contentKey="xddtApp.diemDotBien.thongTinADN">Thong Tin ADN</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {diemDotBienList.map((diemDotBien, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{diemDotBien.giaTri1}</td>
                  <td>{diemDotBien.giaTri2}</td>
                  ...
                  <td>
                    {diemDotBien.thongTinADN ? (
                      <Link to={`thong-tin-adn/${diemDotBien.thongTinADN.id}`}>{diemDotBien.thongTinADN.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
