          ...
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : hoSoLietSiEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="donViLabel" for="donVi">
                    <Translate contentKey="xddtApp.hoSoLietSi.donVi">Don Vi</Translate>
                  </Label>
                  <AvField id="ho-so-liet-si-donVi" type="text" name="donVi" />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  <Label id="chieuCaoLabel" for="chieuCao">
                    <Translate contentKey="xddtApp.hoSoLietSi.chieuCao">Chieu Cao</Translate>
                  </Label>
                  <AvField id="ho-so-liet-si-chieuCao" type="string" className="form-control" name="chieuCao" />
                </AvGroup>
                <AvGroup>
                  <Label id="canNangLabel" for="canNang">
                    <Translate contentKey="xddtApp.hoSoLietSi.canNang">Can Nang</Translate>
                  </Label>
                  <AvField id="ho-so-liet-si-canNang" type="string" className="form-control" name="canNang" />
                </AvGroup>
                <AvGroup>
                  <Label id="nhomMauLabel" for="nhomMau">
                    <Translate contentKey="xddtApp.hoSoLietSi.nhomMau">Nhom Mau</Translate>
                  </Label>
                  <AvField id="ho-so-liet-si-nhomMau" type="text" name="nhomMau" />
                </AvGroup>
                <AvGroup>
                  <Label id="dacDiemRangLabel" for="dacDiemRang">
                    <Translate contentKey="xddtApp.hoSoLietSi.dacDiemRang">Dac Diem Rang</Translate>
                  </Label>
                  <AvField id="ho-so-liet-si-dacDiemRang" type="text" name="dacDiemRang" />
                </AvGroup>
                <AvGroup>
                  <Label id="tinhHuongHySinhLabel" for="tinhHuongHySinh">
                    <Translate contentKey="xddtApp.hoSoLietSi.tinhHuongHySinh">Tinh Huong Hy Sinh</Translate>
                  </Label>
                  <AvField id="ho-so-liet-si-tinhHuongHySinh" type="text" name="tinhHuongHySinh" />
                </AvGroup>
                <AvGroup>
                  <Label id="tinhHuongTimThayLabel" for="tinhHuongTimThay">
                    <Translate contentKey="xddtApp.hoSoLietSi.tinhHuongTimThay">Tinh Huong Tim Thay</Translate>
                  </Label>
                  <AvField id="ho-so-liet-si-tinhHuongTimThay" type="text" name="tinhHuongTimThay" />
                </AvGroup>
                <AvGroup>
                  <Label id="dacDiemNhanDangLabel" for="dacDiemNhanDang">
                    <Translate contentKey="xddtApp.hoSoLietSi.dacDiemNhanDang">Dac Diem Nhan Dang</Translate>
                  </Label>
                  <AvField id="ho-so-liet-si-dacDiemNhanDang" type="text" name="dacDiemNhanDang" />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  ...
                  <AvField id="ho-so-liet-si-udf4" type="text" name="udf4" />
                </AvGroup>
                <AvGroup>
                  <Label id="udf5Label" for="udf5">
                    <Translate contentKey="xddtApp.hoSoLietSi.udf5">Udf 5</Translate>
                  </Label>
                  <AvField id="ho-so-liet-si-udf5" type="text" name="udf5" />
                </AvGroup>
                <AvGroup>
