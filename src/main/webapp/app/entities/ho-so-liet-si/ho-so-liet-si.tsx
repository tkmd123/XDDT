            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('uDF1')}>
                  <Translate contentKey="xddtApp.hoSoLietSi.uDF1">U DF 1</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('uDF2')}>
                  <Translate contentKey="xddtApp.hoSoLietSi.uDF2">U DF 2</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('uDF3')}>
                  <Translate contentKey="xddtApp.hoSoLietSi.uDF3">U DF 3</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
