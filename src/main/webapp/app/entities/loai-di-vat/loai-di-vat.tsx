              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('udf1')}>
                    <Translate contentKey="xddtApp.loaiDiVat.udf1">Udf 1</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('udf2')}>
                    <Translate contentKey="xddtApp.loaiDiVat.udf2">Udf 2</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('udf3')}>
                    <Translate contentKey="xddtApp.loaiDiVat.udf3">Udf 3</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {loaiDiVatList.map((loaiDiVat, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{loaiDiVat.udf1}</td>
                    <td>{loaiDiVat.udf2}</td>
                    <td>{loaiDiVat.udf3}</td>
