              ...
              <AvForm model={isNew ? {} : loaiHinhThaiHaiCotEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="udf1Label" for="udf1">
                    <Translate contentKey="xddtApp.loaiHinhThaiHaiCot.udf1">Udf 1</Translate>
                  </Label>
                  <AvField id="loai-hinh-thai-hai-cot-udf1" type="text" name="udf1" />
                </AvGroup>
                <AvGroup>
                  <Label id="udf2Label" for="udf2">
                    <Translate contentKey="xddtApp.loaiHinhThaiHaiCot.udf2">Udf 2</Translate>
                  </Label>
                  <AvField id="loai-hinh-thai-hai-cot-udf2" type="text" name="udf2" />
                </AvGroup>
                <AvGroup>
                  <Label id="udf3Label" for="udf3">
                    <Translate contentKey="xddtApp.loaiHinhThaiHaiCot.udf3">Udf 3</Translate>
                  </Label>
                  <AvField id="loai-hinh-thai-hai-cot-udf3" type="text" name="udf3" />
                </AvGroup>
