              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('udf1')}>
                    <Translate contentKey="xddtApp.loaiHinhThaiHaiCot.udf1">Udf 1</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('udf2')}>
                    <Translate contentKey="xddtApp.loaiHinhThaiHaiCot.udf2">Udf 2</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('udf3')}>
                    <Translate contentKey="xddtApp.loaiHinhThaiHaiCot.udf3">Udf 3</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {loaiHinhThaiHaiCotList.map((loaiHinhThaiHaiCot, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{loaiHinhThaiHaiCot.udf1}</td>
                    <td>{loaiHinhThaiHaiCot.udf2}</td>
                    <td>{loaiHinhThaiHaiCot.udf3}</td>
