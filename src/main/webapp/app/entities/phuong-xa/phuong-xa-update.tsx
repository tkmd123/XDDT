              ...
              <AvForm model={isNew ? {} : phuongXaEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="isDeletedLabel" check>
                    <AvInput id="phuong-xa-isDeleted" type="checkbox" className="form-control" name="isDeleted" />
