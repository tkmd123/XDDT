            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('isDeleted')}>
                  <Translate contentKey="xddtApp.phuongXa.isDeleted">Is Deleted</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('udf1')}>
                  <Translate contentKey="xddtApp.phuongXa.udf1">Udf 1</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('udf2')}>
                  <Translate contentKey="xddtApp.phuongXa.udf2">Udf 2</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('udf3')}>
                  <Translate contentKey="xddtApp.phuongXa.udf3">Udf 3</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {phuongXaList.map((phuongXa, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{phuongXa.moTa}</td>
                  <td>{phuongXa.isDeleted ? 'true' : 'false'}</td>
                  <td>{phuongXa.udf1}</td>
                  <td>{phuongXa.udf2}</td>
                  <td>{phuongXa.udf3}</td>
