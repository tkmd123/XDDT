              ...
              <AvForm model={isNew ? {} : quanHuyenEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="isDeletedLabel" check>
                    <AvInput id="quan-huyen-isDeleted" type="checkbox" className="form-control" name="isDeleted" />
                    <Translate contentKey="xddtApp.quanHuyen.isDeleted">Is Deleted</Translate>
                  </Label>
                </AvGroup>
                <AvGroup>
                  <Label id="udf1Label" for="udf1">
                    <Translate contentKey="xddtApp.quanHuyen.udf1">Udf 1</Translate>
                  </Label>
                  <AvField id="quan-huyen-udf1" type="text" name="udf1" />
                </AvGroup>
                <AvGroup>
                  <Label id="udf2Label" for="udf2">
                    <Translate contentKey="xddtApp.quanHuyen.udf2">Udf 2</Translate>
                  </Label>
                  <AvField id="quan-huyen-udf2" type="text" name="udf2" />
                </AvGroup>
                <AvGroup>
                  <Label id="udf3Label" for="udf3">
                    <Translate contentKey="xddtApp.quanHuyen.udf3">Udf 3</Translate>
                  </Label>
                  <AvField id="quan-huyen-udf3" type="text" name="udf3" />
                </AvGroup>
                <AvGroup>
