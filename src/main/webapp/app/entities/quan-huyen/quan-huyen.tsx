            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('isDeleted')}>
                  <Translate contentKey="xddtApp.quanHuyen.isDeleted">Is Deleted</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('udf1')}>
                  <Translate contentKey="xddtApp.quanHuyen.udf1">Udf 1</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('udf2')}>
                  <Translate contentKey="xddtApp.quanHuyen.udf2">Udf 2</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('udf3')}>
                  <Translate contentKey="xddtApp.quanHuyen.udf3">Udf 3</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {quanHuyenList.map((quanHuyen, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{quanHuyen.isDeleted ? 'true' : 'false'}</td>
                  <td>{quanHuyen.udf1}</td>
                  <td>{quanHuyen.udf2}</td>
                  <td>{quanHuyen.udf3}</td>
