          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('coHaiCot')}>
                  <Translate contentKey="xddtApp.thongTinKhaiQuat.coHaiCot">Co Hai Cot</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('soLuongHaiCot')}>
                ...
                <th className="hand" onClick={this.sort('udf1')}>
                  <Translate contentKey="xddtApp.thongTinKhaiQuat.udf1">Udf 1</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('udf2')}>
                  <Translate contentKey="xddtApp.thongTinKhaiQuat.udf2">Udf 2</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('udf3')}>
                  <Translate contentKey="xddtApp.thongTinKhaiQuat.udf3">Udf 3</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {thongTinKhaiQuatList.map((thongTinKhaiQuat, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{thongTinKhaiQuat.coHaiCot ? 'true' : 'false'}</td>
                  <td>{thongTinKhaiQuat.soLuongHaiCot}</td>
                  <td>{thongTinKhaiQuat.isDeleted ? 'true' : 'false'}</td>
                  <td>{thongTinKhaiQuat.udf1}</td>
                  <td>{thongTinKhaiQuat.udf2}</td>
                  <td>{thongTinKhaiQuat.udf3}</td>
                  <td>
