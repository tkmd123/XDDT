              ...
              <AvForm model={isNew ? {} : tinhThanhEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="isDeletedLabel" check>
                    <AvInput id="tinh-thanh-isDeleted" type="checkbox" className="form-control" name="isDeleted" />
                    <Translate contentKey="xddtApp.tinhThanh.isDeleted">Is Deleted</Translate>
                  </Label>
                </AvGroup>
                <AvGroup>
                  <Label id="udf1Label" for="udf1">
                    <Translate contentKey="xddtApp.tinhThanh.udf1">Udf 1</Translate>
                  </Label>
                  <AvField id="tinh-thanh-udf1" type="text" name="udf1" />
                </AvGroup>
                <AvGroup>
                  <Label id="udf2Label" for="udf2">
                    <Translate contentKey="xddtApp.tinhThanh.udf2">Udf 2</Translate>
                  </Label>
                  <AvField id="tinh-thanh-udf2" type="text" name="udf2" />
                </AvGroup>
                <AvGroup>
                  <Label id="udf3Label" for="udf3">
                    <Translate contentKey="xddtApp.tinhThanh.udf3">Udf 3</Translate>
                  </Label>
                  <AvField id="tinh-thanh-udf3" type="text" name="udf3" />
                </AvGroup>
